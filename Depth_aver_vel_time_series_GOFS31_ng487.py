...
Q2 = plt.quiver(Xg,Yg,UU31_interp,VV31_interp,scale=0.2,scale_units='inches',\
                color='r',label='GOFS 3.1',alpha=0.5)
qk = plt.quiverkey(Q1, 0.86, 0.92, 0.1, r'$0.1 \frac{m}{s}$', labelpos='E',
...
plt.xticks([datetime(2018,7,15),datetime(2018,7,22),datetime(2018,7,29),\
            datetime(2018,8,5),\
            datetime(2018,8,12),datetime(2018,8,19),datetime(2018,8,26),\
            datetime(2018,9,2),datetime(2018,9,9),datetime(2018,9,16)])
