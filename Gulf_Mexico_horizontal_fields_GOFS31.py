...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 19 14:20:49 2019
...
lon_lim = [-97,-80]
lat_lim = [18,32]
gdata = 'https://data.ioos.us/thredds/dodsC/deployments/rutgers/ng228-20180801T0000/ng228-20180801T0000.nc3.nc'

# Folder where to save figure
folder = '/Users/aristizabal/Desktop/MARACOOS_project/Maria_scripts/Figures/Model_glider_comp/';

#Time window
date_ini = '2018/08/21/00/00'
date_end = '2018/08/22/00/00'
...
for i,ind in enumerate(oktime31[0]):
    ...
    kw = dict(levels=np.linspace(34,37,16), 
           cmap=plt.cm.jet)
    ...
    file = folder + '{0}_{1}.png'.format('Salt_Gulf_Mexico',\
                     time31[i])
...
max_v = np.nanmax(abs(var))
kw = dict(levels=np.linspace(30,38,9), 
           cmap=plt.cm.jet)
...
#%% Figures temperature surface

folder = '/Users/aristizabal/Desktop/MARACOOS_project/Maria_scripts/Figures/Model_glider_comp/'

for i,ind in enumerate(oktime31[0]):
    T31 = GOFS31['water_temp'][ind,0,botm:top,left:right]
    var = T31
    ...
    max_v = np.nanmax(abs(var))
    kw = dict(levels=np.linspace(25,33,9), 
              cmap=plt.cm.jet)
    plt.contour(lon31g,lat31g, var,**kw)
    plt.contourf(lon31g,lat31g, var, **kw)
    ...
    file = folder + '{0}_{1}.png'.format('Temp_GOFS31_Gulf_Mexico',\
                     time31[i])
    plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)     
