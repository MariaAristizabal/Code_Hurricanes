...
colors = ['green','indianred','purple','c','y','r','b','seagreen',\
...
file = folder_fig + 'Map_SAB_20200619_20201025'
...
DF_RTOFS_temp_salt.to_pickle('DF_RTOFS_temp_salt_SAB.pkl')
DF_RTOFS_MLD.to_pickle('DF_RTOFS_MLD_SAB.pkl')
DF_RTOFS_OHC.to_pickle('DF_RTOFS_OHC_SAB.pkl')
DF_RTOFS_T100.to_pickle('DF_RTOFS_T100_SAB.pkl')
DF_RTOFS_PEA.to_pickle('DF_RTOFS_PEA_SAB.pkl')

DF_RTOFS_DA_temp_salt.to_pickle('DF_RTOFS_DA_temp_salt_SAB.pkl')
DF_RTOFS_DA_MLD.to_pickle('DF_RTOFS_DA_MLD_SAB.pkl')
DF_RTOFS_DA_OHC.to_pickle('DF_RTOFS_DA_OHC_SAB.pkl')
DF_RTOFS_DA_T100.to_pickle('DF_RTOFS_DA_T100_SAB.pkl')
DF_RTOFS_DA_PEA.to_pickle('DF_RTOFS_DA_PEA_SAB.pkl')

DF_GOFS_temp_salt.to_pickle('DF_GOFS_temp_salt_SAB.pkl')
DF_GOFS_MLD.to_pickle('DF_GOFS_MLD_SAB.pkl')
DF_GOFS_OHC.to_pickle('DF_GOFS_OHC_SAB.pkl')
DF_GOFS_T100.to_pickle('DF_GOFS_T100_SAB.pkl')
DF_GOFS_PEA.to_pickle('DF_GOFS_PEA_SAB.pkl')

#%% Load all data frames
'''
DF_RTOFS_temp_salt = pd.read_pickle('DF_RTOFS_temp_salt_SAB.pkl')
DF_RTOFS_MLD = pd.read_pickle('DF_RTOFS_MLD_SAB.pkl')
DF_RTOFS_OHC = pd.read_pickle('DF_RTOFS_OHC_SAB.pkl')
DF_RTOFS_T100 = pd.read_pickle('DF_RTOFS_T100_SAB.pkl')
DF_RTOFS_PEA = pd.read_pickle('DF_RTOFS_PEA_SAB.pkl')

DF_RTOFS_DA_temp_salt = pd.read_pickle('DF_RTOFS_DA_temp_salt_SAB.pkl')
DF_RTOFS_DA_MLD = pd.read_pickle('DF_RTOFS_DA_MLD_SAB.pkl')
DF_RTOFS_DA_OHC = pd.read_pickle('DF_RTOFS_DA_OHC_SAB.pkl')
DF_RTOFS_DA_T100 = pd.read_pickle('DF_RTOFS_DA_T100_SAB.pkl')
DF_RTOFS_DA_PEA = pd.read_pickle('DF_RTOFS_DA_PEA_SAB.pkl')

DF_GOFS_temp_salt = pd.read_pickle('DF_GOFS_temp_salt_SAB.pkl')
DF_GOFS_MLD = pd.read_pickle('DF_GOFS_MLD_SAB.pkl')
DF_GOFS_OHC = pd.read_pickle('DF_GOFS_OHC_SAB.pkl')
DF_GOFS_T100 = pd.read_pickle('DF_GOFS_T100_SAB.pkl')
DF_GOFS_PEA = pd.read_pickle('DF_GOFS_PEA_SAB.pkl')
'''
...
file = folder_fig + 'Taylor_norm_RTOFS_RTOFS_DA_GOFS_SAB'
plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)
